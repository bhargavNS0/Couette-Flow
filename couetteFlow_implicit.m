% Numerical analysis of Couette flow using Implicit scheme in FDM
...
deltaY = 1/n;
y = 0:deltaY:1;
deltaT = 10000;         % Time step size has no effect on stability of the solution
...
% In this case, steady state achieved at 313th timestep